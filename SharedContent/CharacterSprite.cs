...
namespace SharedContent
{
    public class CharacterSprite
    {
        ...
        public CharacterSprite(Enum id, List<Texture2D> textures, Vector2 origin)
        {
            this.id = id;
        ...
        public CharacterSprite(Enum id, List<Texture2D> textures, int frames, Rectangle rect, Vector2 origin, float speed)
        {
            this.id = id;
            this.textures = textures;
            this.frames = frames;
